                        ...
                        <div className="min-[250px]:flex min-[250px]:flex-col min-[250px]:items-center md:items-start">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    className="block p-2 min-[250px]:w-[80vw] sm:w-[50vw] md:w-[40vw] lg:w-[30vw] xl:w-[28vw] 2xl:w-[20vw] rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm/6"
                                />
                            </div>
                        </div>
